...
public class FirstGeneEditObserver : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        _contoller.TryStartTutorial(TutorialTriggerKey.FirstGeneEdit);
    }
    private bool TutorialCompleted()
    {
        bool isFirstEditConpleted = _save.CurrentData.UserData.tutorialFlags.FirstGeneEdit;
